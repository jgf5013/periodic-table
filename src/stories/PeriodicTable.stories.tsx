...
import PeriodicTable, { PeriodicTableProps } from '../components/periodic-table/PeriodicTable';

export default {
  title: 'Example/PeriodicTable',
  component: PeriodicTable,
} as Meta;

const Template: Story<PeriodicTableProps> = (args) => <PeriodicTable {...args} />;
